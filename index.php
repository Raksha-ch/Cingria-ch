...
<body>
  ...
  <div class="container" >
    ...
    <span style="color: #B2B8BA; font-family:'Raleway'; text-shadow: 0px 1px 1px #212222;">Association des Amis de<br/>Charles-Albert Cingria</span>
        <span style="font-size: 0.6em; clear:both; display: block; line-height: 0.9em; margin: 3px 0 0 0; ">2 avenue des Belles-Roches<br/>1004 Lausanne &middot; Suisse</span>
      <div id="signature" style="font-size: 0.41176470588235em; clear:both; display: block; line-height: 0.6em; margin: 38px 0 0 -4px; color: #B2B8BA; letter-spacing: 1px;">
        ...
        <div id="signature_text" class="signature"><a href="http://www.societe-ecran.tv" onclick="window.open(this.href, '_blank'); return false;">SOCIETE-ECRAN MEDIA</a></div><div class="signature" style="color:#272729; float:left; margin: 0 0 0 4px;"><?php $start = 2011; print $start;if(date('Y')!= $start) { print '-'.date('y');}?></div>
      </div>
        </div>
...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready(function() {
          ...
          $(".masonry_item img").fullsize({shadow: true, forceTitleBar: false});
      ...
      $('#signature_text').hover(
        ...
        function() {
            $(this).stop().fadeTo(100,1).animate({marginLeft: '6px'},80, function(){ $('#signature_arrow').fadeTo(100,1) });
        },
        function() {

          $(this).stop().fadeTo(500,0.5).animate({marginLeft: '0'},120, function(){ $('#signature_arrow').fadeTo(100,0); });
      }
       );
  ...
  $('.close_sub').click(function(){
      ...
      $.scrollTo( $(this).parent().parent().parent(), 1400,{easing:"easeInOutExpo"});
