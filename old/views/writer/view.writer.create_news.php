	 		...
	 		<fieldset> 
	 			<ol>
					<li>
	 					...
	 					<input type="text" class="input" name="news_title" value="<?php print $_POST['news_title'] ?>" />
	 				</li>
					<li>
	 					<label>Intitul&eacute; 2&egrave;me ligne</label>
	 					<input type="text" class="input" name="news_title_2" value="<?php print $_POST['news_title_2'] ?>" />
	 				</li>
					<li>
	 					<label>Intitul&eacute; 3&egrave;me ligne</label>
	 					<input type="text" class="input" name="news_title_3" value="<?php print $_POST['news_title_3'] ?>" />
	 				</li>
						<li>
						...
						<li>
							<label>Artistes du concert<br/><span class="tinygreyinfo">Double-cliquer sur un nom pour le <strong>retirer</strong> de la liste</span></label>
								...
								onDblClick="move(document.combo_box['pool_list_2[]'],document.combo_box.pool_list_1)"></select>
						</li>
					<li>
			 			<label>Date publique<br/><span class="tinygreyinfo">ex. 1er Janvier 2000<br/>ou 01.01.2000</span></label>
			 			<input type="text" class="input" name="news_public_date" value="<?php print $_POST['news_public_date'] ?>" />
			 		</li>
 		...
 		<fieldset> 
 			<ol>
 				...
 				<li>
 					...
 					<input type="text" class="input" name="news_subtitle" value="<?php print $_POST['news_description'] ?>" />
 				</li>
 				<li>
					...
					<select name="upload_file_id" class="short_select">
						...
						<?php
							...
							foreach ($rowx as $rox) {
								...
								print '<option value="'.$rox['upload_file_id'].'">'.$dir_name.'/'.$rox['upload_file_name'].$rox['upload_file_ext'].$status.'</option>';
							}
						?>
					</select>
				</li>
	 		...
	 		<fieldset> 
	 			<ol>
	 				<li>
	 					...
	 					<input type="text" class="input" name="news_short_title" value="<?php print $_POST['news_description'] ?>" />
	 				</li>
 		...
 		<fieldset> 
 			<ol>
 					...
 					<select name="news_category_id" class="short_select">
 						...
 						foreach ($rowx as $keyz) {
 							print '<option value="'.$keyz['news_category_id'].'"';
								if($keyz['news_category_id'] == $_POST['news_category_id']) { print ' selected="selected"' ;}
						...
						$where = " subcategory_parent_id != '0' ";
 						...
 						foreach ($rowx as $keyz) {
 							print '<option value="'.$keyz['subcategory_id'].'"';
								if($keyz['subcategory_id'] == $_POST['subcategory_id']) { print ' selected="selected"' ;}
				...
				<li>
 					...
 					<input type="text" class="input" name="news_time" value="<?php print $_POST['news_time'] ?>" />
 				</li>
 		...
 		<div class="form_div">
 			<fieldset> 
 						...
 						<ol>
	 						...
	 						<textarea class="long_textarea_input" name="news_content"><?php print $_POST['news_content'] ?></textarea>
 ...
 <div class="form_div">
 	<fieldset> 
 					...
 					<li>
 						...
 						<select name="news_publication_start_date_y">
 							...
 							for ($y; $y < $y_2; $y++) {
 								...
 								if ( isset( $_POST['news_publication_start_date_y'] ) ) {
 						...
 						<select name="news_publication_start_date_d">
 							...
 							?>
 						</select> <span class="tinygreyinfo">&nbsp; [aujourd'hui]</span>
 			...
 			<div class="form_div">
 				...
 				<li class="bottom">
 					<label>&nbsp;</label>
					<input type="hidden" name="news_creation_date" value="<?php print date('Y-m-d');?>" />
